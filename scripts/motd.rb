...
def get_tidbit(resource)
    return get('https://machin.dev/tidbit/' + resource).body
end
...
print "\n"
print "  Monthly AWS spend: #{get_tidbit('aws_balance')} (#{get_tidbit('aws_forecast')} forecasted)\n" 
print "\n"
print "  " + get_tidbit('horoscope').italics + "\n"
print "\n"
